            ...
            <div class="app-card issue-panel p-4 p-lg-5">
                <div class="section-header mb-0">
                    <div>
                        ...
                        <p class="mb-0 text-muted">Filter issues by ticket, status, category, and location to manage the civic workflow.</p>
                    </div>
            ...
            <div class="app-card bg-white p-4">
                <div class="section-header">
                    <div>
                        ...
                        <p class="text-muted mb-0">Administrators can open a ticket to manage assignment and response notes.</p>
                    </div>
                </div>
