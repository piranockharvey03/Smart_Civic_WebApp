...
$pageTitle = APP_NAME . ' | My Reported Issues Map';
$activePage = 'citizen-map';
$pageStyles = [
        ...
        <div class="col-12">
            <div class="app-card issue-panel p-4 p-lg-5">
                <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center">
                    <div>
                        <p class="text-uppercase small text-muted mb-2">My Reported Issues</p>
                        <h1 class="h3 mb-2">My Issue Map</h1>
                        <p class="mb-0 text-muted">View all your reported civic issues on a spatial map with location coordinates.</p>
                    </div>
                    <div class="d-flex flex-wrap gap-2">
                        <a href="<?= e(app_url('citizen/dashboard.php')) ?>" class="btn btn-outline-primary">Dashboard</a>
                        <a href="<?= e(app_url('citizen/issues.php')) ?>" class="btn btn-primary">My Issues</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3">
            <div class="app-card bg-white p-4 mb-4">
                ...
                <div class="d-grid gap-2 compact-stack">
                    ...
                    <?php if (!$divisionBreakdown) : ?>
                        <div class="alert alert-info mb-0">No reported issues with coordinates are available yet.</div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="app-card bg-white p-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <div class="small text-muted mt-2">Marker clusters reduce overcrowding. Heatmap highlights location density across your reported issues.</div>
                </div>
            </div>
        </div>
    </div>
