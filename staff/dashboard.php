...
$latestIssues = array_slice(issue_fetch_management_issues(['status' => 'submitted']), 0, 3);
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="app-card issue-panel p-4 p-lg-5">
                ...
                <p class="mb-3">Monitor incoming civic issues, assign work, and keep citizens informed.</p>
        ...
        <div class="col-lg-12">
            <div class="app-card bg-white p-4">
                <h2 class="h5 mb-3">Submitted Queue</h2>
                <?php if (!$latestIssues) : ?>
                    <p class="text-muted mb-0">No newly submitted issues are waiting in the queue.</p>
                <?php else : ?>
